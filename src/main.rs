fn main() {
            ...
            let latest_settlements: Vec<_> = settlement_rows
                ...
                .map(|r| {
                    serde_json::json!({
                        ...
                        "climate_pdsi": r.climate_pdsi,
                        "drought_index_5y": r.drought_index_5y,
                        "water_reliability": r.water_reliability,
                        "water_quality": r.water_quality,
                        "fuel_stock": r.fuel_stock,
                        "food_yield_kcal": r.food_yield_kcal,
                        ...
                        "disease_infected_share": r.disease_infected_share,
    ...
    let summary = mabm::RunManifestSummary {
        hex_count: result.final_state.hex_count as usize,
